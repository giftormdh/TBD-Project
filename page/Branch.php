    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-md-10 content scrollable-table">
          ...
          <h3 class="centered-bold">Store Branch</h3>
          <table class="table table-bordered">
            ...
            <tbody>
              <?php
                $DetailsOfBranch = postgreQuery('SELECT * FROM bookstore."bookstore_branch"');
                foreach ($DetailsOfBranch as $index => $row):
                  $NameOfBranch = substr($row['store_name'], 0, 100);
